        ...
        <span class="fi-pagination-overview">
            {{
                trans_choice(
                    ...
                    $paginator->total(),
                    [
                        'first' => LocaleNumber::format($paginator->firstItem() ?? 0),
                        'last' => LocaleNumber::format($paginator->lastItem() ?? 0),
                        'total' => LocaleNumber::format($paginator->total()),
                    ],
                )
            }}
        </span>
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        <x-filament::pagination.item
                            ...
                            :aria-label="trans_choice('filament::components/pagination.actions.go_to_page.label', $page, ['page' => LocaleNumber::format($page)])"
                            :label="LocaleNumber::format($page)"
